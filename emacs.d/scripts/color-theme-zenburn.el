...
(defvar zenburn-fg "#cbcbbb")
(defvar zenburn-fg-1 "#545444")
(defvar zenburn-bg-1 "#1a1a1a")
(defvar zenburn-bg "#2e2e2e")
(defvar zenburn-bg+1 "#3e3e3e")
(defvar zenburn-bg+2 "#4e4e4e")
(defvar zenburn-bg+3 "#5e5e5e")
(defvar zenburn-red+1 "#cb9292")
(defvar zenburn-red "#bb8282")
(defvar zenburn-red-1 "#ab7272")
(defvar zenburn-red-2 "#9b6262")
(defvar zenburn-red-3 "#8b5252")
(defvar zenburn-red-4 "#7b4242")
(defvar zenburn-orange "#ce9e7e")
(defvar zenburn-yellow "#e0ce9e")
(defvar zenburn-yellow-1 "#d0be8e")
(defvar zenburn-yellow-2 "#c0ae7e")
(defvar zenburn-green-1 "#4e6e4e")
(defvar zenburn-green "#6e8e6e")
(defvar zenburn-green+1 "#7ea17e")
(defvar zenburn-green+2 "#8eb48e")
(defvar zenburn-green+3 "#9ec79e")
(defvar zenburn-green+4 "#aedaae")
(defvar zenburn-cyan "#82d0d2")
(defvar zenburn-blue+1 "#83aee2")
(defvar zenburn-blue "#7bc0c2")
(defvar zenburn-blue-1 "#6ba7aa")
(defvar zenburn-blue-2 "#5b9092")
(defvar zenburn-blue-3 "#4b777a")
(defvar zenburn-blue-4 "#3b6062")
(defvar zenburn-blue-5 "#255050")
(defvar zenburn-magenta "#cb7bb2")
