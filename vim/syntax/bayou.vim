" Vim syntax file
" Language:	Bayou
" Maintainer:	Jeff McGee
" Last Change:	2009-10-13
" Credits: complete rip-off of the python vim syntax by these people:
...
syn keyword pythonStatement	class def gamephase nextgroup=pythonFunction skipwhite
syn keyword pythonConditional	elif else if option case
...
syn match   pythonFunction
      \ "\%(\%(gamephase\s|def\s\|class\s\|@\)\s*\)\@<=\h\%(\w\|\.\)*" contained
...
syn sync match pythonSync grouphere NONE "^\s*\%(gamephase\|def\|class\)\s\+\h\w*\s*("
